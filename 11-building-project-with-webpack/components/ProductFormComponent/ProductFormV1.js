...
import { BACKEND_URL, IMGUR_URL, IMGUR_CLIENT_ID } from '../../constants/index.js';
...
export default class ProductForm extends BaseComponent {
  ...
  handleUploadImageInputChange = async () => {
    try {
      ...
      this.subElements.productForm.elements.uploadImageButton.classList.add('is-loading');
      ...
      this.subElements.productForm.elements.uploadImageButton.classList.remove('is-loading');
    }
  }
